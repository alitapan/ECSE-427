...
static sem_t in_mutex;
static sem_t wrt_mutex;
static sem_t mutex;
...
static void *writerFunc(void *args){
	...
	for(int i = 0; i < loops; i++)
	{
        ...
        //Critical Section - Increment and store
...
int main(int argc, char *argv[])
{
    ...
    if(sem_init(&in_mutex,0,1) == -1 || sem_init(&mutex,0,1) == -1 || sem_init(&wrt_mutex,0,1) == -1)
  	{
